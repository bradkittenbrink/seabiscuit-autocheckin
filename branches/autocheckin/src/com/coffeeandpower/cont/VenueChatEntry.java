...
public class VenueChatEntry {
    ...
    public VenueChatEntry(String chatId, String userId, String entry,
            String author, String fileName, String ip, String date,
            String systemType, String systemData_userId,
            String systemData_author, String systemData_fineName) {
        this.chatId = chatId;
        this.userId = userId;
        this.entry = entry;
        this.author = author;
