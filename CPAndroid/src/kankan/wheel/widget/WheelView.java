...
public class WheelView extends View
	{
		...
		/**
		 * Sets the desired count of visible items. Actual amount of visible
		 * items depends on wheel layout parameters. To apply changes and
				...
				if (scrollingOffset != 0)
					{
						...
						// process empty items above the first or below the
						// second
		...
		/**
		 * Updates view. Rebuilds items and label if necessary, recalculate
		 * items sizes.
		 */
