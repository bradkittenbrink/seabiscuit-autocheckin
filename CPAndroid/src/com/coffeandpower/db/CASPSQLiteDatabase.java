...
public class CASPSQLiteDatabase  extends SQLiteOpenHelper{
	...
	public static final String COLUMN_CONTROL_FQS_ID = "controlfqsid";  // in this column foursquareId is written, for getting data from db
	...
	private static final String DATABASE_CREATE = "create table "
			...
			+ COLUMN_CONTROL_FQS_ID + " text, "
			+ COLUMN_CHECK_IN_ID + " integer, "
			+ COLUMN_USER_ID + " integer, "
			+ COLUMN_NICK_NAME + " text, "
			+ COLUMN_STATUS_TEXT + " text, "
			+ COLUMN_PHOTO + " text, "
			+ COLUMN_MAJOR_JOB + " text, "
			+ COLUMN_MINOR_JOB + " text, "
			+ COLUMN_HEAD_LINE + " text, "
			+ COLUMN_FILE_NAME + " text, "
			+ COLUMN_LAT + " text, "
			+ COLUMN_LNG + " text, "
			+ COLUMN_CHECKED_IN + " integer, "
			+ COLUMN_FOURSQUARE_ID + " text, "
			+ COLUMN_VENUE_NAME + " text, "
			+ COLUMN_CHECK_IN_COUNT + " integer, "
			+ COLUMN_SKILLS + " text, "
			+ COLUMN_MET + " text);";
