...
public class ActivityCheckInList extends ListActivity implements Observer {
    ...
    protected Handler taskHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (venueArrayReference != null
                ...
                venueArray.add(VenueSmart.createVenuePlaceholder("add_place",
                        "Add New Place..."));
    ...
    protected void onStart() {
        ...
        AppCAP.getCounter().getCachedDataForAPICalls("venuesWithCheckins",
                "nearbyVenues", this);
    }
    ...
    public void update(Observable observable, Object data) {
        ...
        if (this.nearbyVenuesHolderWORKERTHREAD != null
            ...
            @SuppressWarnings("unchecked")
            ArrayList<VenueSmart> arrayVenues = (ArrayList<VenueSmart>) nearbyVenuesHolderWORKERTHREAD
                    .getObject();
            ...
            bundle.putParcelableArrayList("venuesWCheckins",
                    arrayVenuesWCheckins);
            message.setData(bundle);

            if (Constants.debugLog)
                Log.d("CheckInList",
                        "ActivityCheckInList.update: Sending handler message with "
