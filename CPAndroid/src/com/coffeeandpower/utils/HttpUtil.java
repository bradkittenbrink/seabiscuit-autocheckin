										...
										if (payload != null)
											{
												...
												majorJob = payload.optString ("major_job_category");
												minorJob = payload.optString ("minor_job_category");
																		...
																		if (objReviewFromArray != null)
																			{
																				...
																				reviews.add (new Review (objReviewFromArray.optInt ("id"), objReviewFromArray.optString ("author"),
																						objReviewFromArray.optString ("title"), objReviewFromArray.optString ("type"),
																						objReviewFromArray.optString ("create_time"), objReviewFromArray.optString ("skill"),
																						objReviewFromArray.optString ("rating"), objReviewFromArray.optString ("is_love"),
																						objReviewFromArray.optString ("tip_amount"), objReviewFromArray.optString ("review"),
																						objReviewFromArray.optString ("ratingImage"), objReviewFromArray.optString ("relativeTime")));
																			}
																	}
															}
													}
												...
												// [0] Object UserResume, [1]
												// array list favourite
												// checkin locatios
												ArrayList<Object> tempHolder = new ArrayList<Object> ();
												tempHolder.add (new UserResume (nickName, majorJob, minorJob, statusText, urlPhoto, urlPhotoLarge, joined, bio, totalEarned, totalTipsEarned,
														totalMissionCountAsRecipient, distinctTipPayers, totalSpent, totalTipsSpent, totalMissionCountAsPayer,
														distinctTipRecipients, totalEarnedFromMe, totalMissionsFromMe, totalMissionsAsAgent, totalMissionsAsClient, totalMissions,
														totalFunded, skillSet, hourlyBillingRate, verifiedLinkedIn, linkedInProfileLink, verifiedFacebook, facebookProfileLink,
														verifiedMobile, trusted, jobTitle, checkInId, userId, lat, lng, checkInDate, checkIn, checkOutDate, checkOut, foursquare,
														foursquareId, venueName, venueAddress, city, state, zip, phone, icon, visible, photoUrlUnUsed, formattedPhone, usersHere,
														reviewsPage, reviewsTotal, reviewsRecords, reviewsLoveReceived, reviews, education, work, locationLat, locationLng));
																...
																if (objMess != null)
																	{
																		messages.add (new ChatMessage (objMess.optInt ("id"), objMess.optInt ("user_id"), objMess
																				.optString ("entry_text"), objMess.optString ("nickname"), objMess.optString ("date"), objMess
																				.optString ("photo_url"), objMess.optInt ("receiving_user_id"), objMess.optInt ("offer_id")));
																	}
															}
													}
		...
		public DataHolder getVenuesAndUsersWithCheckinsInBoundsDuringInterval (double data[], int numberOfDays)
			{
				...
				HttpGet get = new HttpGet (AppCAP.URL_WEB_SERVICE + AppCAP.URL_API + "?action=getVenuesAndUsersWithCheckinsInBoundsDuringInterval" + "&sw_lat=" + data[0]
						+ "&sw_lng=" + data[1] + "&ne_lat=" + data[2] + "&ne_lng=" + data[3] + "&checked_in_since=" + (System.currentTimeMillis () / 1000 - (86400 * numberOfDays))
						+ userLat + userLng + "&version=0.1");
																...
																if (objVenue != null)
																	{
																		...
																		venues.add (new VenueSmart (objVenue.optString ("name"), objVenue.optString ("address"), objVenue
																				.optString ("city"), objVenue.optString ("state"), objVenue.optString ("distance"), objVenue
																				.optString ("foursquare"), objVenue.optInt ("checkins"), objVenue.optInt ("checkins_for_week"),
																				objVenue.optInt ("checkins_for_interval"), objVenue.optString ("photo_url"), objVenue
																						.optString ("phone"), objVenue.optString ("formatted_phone"), objVenue.optDouble ("lat"),
																				objVenue.optDouble ("lng"), arrayCheckins));
																	}
															}
													}
																...
																if (objUser != null)
																	{
																		...
																		UserSmart singleUserMap = new UserSmart (objUser.optInt ("checkin_id"), objUser.optInt ("id"),
																		...
																		if (venue != null)
																			{
																				...
																				venuesArray.add (new Venue (id, name, address, crossStreet, lat, lng, distance, postalCode, city,
																						state, country, categoryName, categoryPluralName, categoryShortName, checkinsCount,
																						usersCount, tipCount, hereNowCount, "", ""));
																			}
																	}
										...
										if (objPayload != null)
											{
												...
												result.setObject (new UserTransaction (objPayload.optInt ("userid"), objPayload.optString ("nickname"), objPayload
														...
														.optString ("active"), objPayload.optString ("photo"), objPayload.optString ("photo_large"), objPayload.optDouble ("lat"),
														objPayload.optDouble ("lng"), objPayload.optInt ("favorite_enabled"), objPayload.optInt ("favorite_count"), objPayload
																.optInt ("my_favorite_count"), objPayload.optInt ("money_received"), objPayload.optInt ("offers_paid"), objPayload
																.optInt ("balance"), transactions));
											}
										return result;
									}
							}
