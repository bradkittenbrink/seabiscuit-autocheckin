...
public class HttpUtil {
    ...
    public DataHolder sendAcceptContactRequestFromUserId(int userId) {
        ...
        try {
            ...
            String responseString = EntityUtils.toString(resEntity);
            RootActivity.log("HttpUtil_sendAcceptContactRequestFromUserId: "
                    + responseString);
    ...
    public DataHolder checkIn(VenueSmart venue, int checkInTime,
            int checkOutTime, String statusText) {
    ...
    public DataHolder getNearestVenuesWithCheckinsToCoordinate(double[] coords) {
        ...
        try {
            ...
            String responseString = EntityUtils.toString(resEntity);
            RootActivity
                    .log("HttpUtil_getNearestVenuesWithCheckinsToCoordinate: "
                            + responseString);
        ...
        try {
            ...
            if (responseString != null) {
                ...
                if (json != null) {
                    ...
                    result.setObject(new User(userId, favoriteEnabled,
                            favoriteCount, myFavoriteCount, moneyReceived,
                            offersPaid, nickName, userName, statusText, status,
                            active, photo, photoLarge, lat, lng));
