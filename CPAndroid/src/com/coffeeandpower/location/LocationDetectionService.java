...
public class LocationDetectionService extends Service {
    ...
    private static class ProximityReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (entering) {
                ...
                instance.debugMessage("Entering fence for " + venue.getName());
            } else {
                instance.debugMessage("Exiting fence for " + venue.getName());
                exe.checkOut();
    ...
    private void debugMessage(final String msg) {
        ...
        if(Constants.debugLocationToast) {
            mainThreadTaskHandler.post(new Runnable() {
                @Override public void run() {
                    Toast.makeText(LocationDetectionService.this, msg, Toast.LENGTH_LONG).show();
                }
            });
        }
    }
