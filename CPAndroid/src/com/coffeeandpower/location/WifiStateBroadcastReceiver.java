...
class WifiStateBroadcastReceiver extends BroadcastReceiver implements Observer {
        ...
        if (WifiManager.NETWORK_STATE_CHANGED_ACTION.equals(action)) {
            ...
            if (networkInfo.getState().equals(NetworkInfo.State.CONNECTED)) {
                ...
                if (!AppCAP.isUserCheckedIn()) {
                  String ssid = grabCurrentSSID(context);
                  ...
                  ArrayList<VenueSignature> testVenuesBeingVerified = AppCAP.getAutoCheckinVenueSignatures();
                  for(VenueSignature venueUnderTest:testVenuesBeingVerified) {
