...
public class VenueSmart
{
	...
	public VenueSmart(String name, String address, String city, String state, String distance, String foursquareId,
			int checkins, int checkinsForWeek, int checkinsForInterval, String photoURL, String phone,
			String formattedPhone, double lat, double lng, ArrayList<CheckinData> arrayCheckins)
	{
		this.name = name;
