...
public class UserTransaction {
    ...
    public UserTransaction(int userId, String nickName, String userName, String statusText, String userStatus, String active,
	    String photo, String photoLarge, double lat, double lng, int favoriteEnabled, int favoriteCount, int myFavoriteCount,
	    int moneyReceived, int offersPaid, int balance, ArrayList<Transaction> transactions) {
