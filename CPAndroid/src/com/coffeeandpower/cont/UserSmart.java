...
public class UserSmart implements Serializable {
    ...
    public UserSmart(int checkInId, int userId, String nickName, String statusText, String photo, String majorJobCategory,
	    String minorJobCategory, String headLine, String fileName, double lat, double lng, int checkedIn,
	    String foursquareId, String venueName, int checkInCount, String skills, boolean met) {
	super();
