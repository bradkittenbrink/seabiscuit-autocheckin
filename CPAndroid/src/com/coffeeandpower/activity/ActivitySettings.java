			...
			case HANDLE_UPLOAD_PROFILE_PHOTO:
				if (resultPhotoUpload != null)
				{
					if (resultPhotoUpload.getObject() != null)
					{
						...
						{
							new CustomDialog(ActivitySettings.this, "Info", (String) resultPhotoUpload.getObject())
									.show();
							loadProfilePhoto();
						}
					}
	...
	public void onActivityResult(int requestCode, int resultCode, Intent intent)
	{
		...
		case PROFILE_PIC_REQUEST:
			...
			if (resultCode == RESULT_OK)
			{
				...
				{
					new CustomDialog(ActivitySettings.this, "Info", "Unable to save picture! We are working on that...")
							.show();
				}
			}
		...
		if (result != null)
		{
			if (result.getObject() != null)
			{
				if ((Boolean) result.getObject())
				{
					...
					// Nick name or Email was changed, so get user data again,
					// refresh it
